...
class CreateAnalysisRequest(BaseModel):
    ...
    analysis_method: str = Field(default="llm", description="分析方法: 'llm' | 'cluster'")
    ...
    def validate_mode(self):
        ...
        if self.analysis_method not in ("llm", "cluster"):
            raise ValueError(f"不支持的 analysis_method: {self.analysis_method}")
        return self
